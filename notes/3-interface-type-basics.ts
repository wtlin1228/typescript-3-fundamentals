...
const x: NumVal = [1, 2, 3, 1, [1, 1, 2, 3]];
...
const emailer1: ContactMessenger1 = (_contact, _message) => {
  /** ... */
};
...
const myFoo = createContact(Foo, 'leo', 'wtlin1228@gmail.com');
...
if (phoneDict.office) {
  ...
  console.log(phoneDict.office.num);
  console.log(phoneDict.office.foo); // error
}
...
const x3: StringVal = Math.random() > 0.5 ? 'b' : ['a']; // ✅ ok!
